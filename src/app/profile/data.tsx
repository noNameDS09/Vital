...
export const patients: Patient[] = [
  {
    ...
    vitalCards: [
      ...
      { name: 'SpO₂', value: 90, unit: '%', icon: <Atom size={24} />, color: 'var(--chart-4)', threshold: { critical: [0, 90], warning: [90, 95] } },
  ...
  },
  {
    ...
    vitalCards: [
      { name: 'Heart Rate', value: 125, unit: 'bpm', icon: <Heart size={24} />, color: 'var(--primary)', threshold: { critical: [30, 110], warning: [40, 100] } },
      { name: 'SpO₂', value: 78, unit: '%', icon: <Atom size={24} />, color: 'var(--chart-4)', threshold: { critical: [0, 90], warning: [90, 95] } },
      { name: 'Blood Pressure', value: '135/90', unit: 'mmHg', icon: <Droplet size={24} />, color: 'var(--chart-2)', threshold: { critical: [0, 140], warning: [120, 139] } },
    ],
  },
  {
    id: 3,
    ...
    vitalCards: [
      { name: 'Heart Rate', value: 80, unit: 'bpm', icon: <Heart size={24} />, color: 'var(--primary)', threshold: { critical: [30, 110], warning: [40, 100] } },
      { name: 'SpO₂', value: 96, unit: '%', icon: <Atom size={24} />, color: 'var(--chart-4)', threshold: { critical: [0, 90], warning: [90, 95] } },
      { name: 'Blood Pressure', value: '148/96', unit: 'mmHg', icon: <Droplet size={24} />, color: 'var(--chart-2)', threshold: { critical: [0, 140], warning: [120, 139] } },
    ],
  },
  {
    id: 4,
    ...
    vitalCards: [
      { name: 'Heart Rate', value: 115, unit: 'bpm', icon: <Heart size={24} />, color: 'var(--primary)', threshold: { critical: [30, 110], warning: [40, 100] } },
      { name: 'SpO₂', value: 90, unit: '%', icon: <Atom size={24} />, color: 'var(--chart-4)', threshold: { critical: [0, 90], warning: [90, 95] } },
      { name: 'Blood Pressure', value: '150/100', unit: 'mmHg', icon: <Droplet size={24} />, color: 'var(--chart-2)', threshold: { critical: [0, 140], warning: [120, 139] } },
    ],
  },
  {
    id: 5,
    ...
    vitalCards: [
      { name: 'Heart Rate', value: 90, unit: 'bpm', icon: <Heart size={24} />, color: 'var(--primary)', threshold: { critical: [30, 110], warning: [40, 100] } },
      { name: 'SpO₂', value: 96, unit: '%', icon: <Atom size={24} />, color: 'var(--chart-4)', threshold: { critical: [0, 90], warning: [90, 95] } },
      { name: 'Blood Pressure', value: '170/110', unit: 'mmHg', icon: <Droplet size={24} />, color: 'var(--chart-2)', threshold: { critical: [0, 140], warning: [120, 139] } },
    ],
  },
  {
    id: 6,
    ...
    alerts: [],
    vitalCards: [
      { name: 'Heart Rate', value: 74, unit: 'bpm', icon: <Heart size={24} />, color: 'var(--primary)', threshold: { critical: [30, 110], warning: [40, 100] } },
      { name: 'SpO₂', value: 99, unit: '%', icon: <Atom size={24} />, color: 'var(--chart-4)', threshold: { critical: [0, 90], warning: [90, 95] } },
      { name: 'Blood Pressure', value: '119/74', unit: 'mmHg', icon: <Droplet size={24} />, color: 'var(--chart-2)', threshold: { critical: [0, 140], warning: [120, 139] } },
    ],
  },
  {
    id: 7,
    ...
    vitalCards: [
      { name: 'Heart Rate', value: 110, unit: 'bpm', icon: <Heart size={24} />, color: 'var(--primary)', threshold: { critical: [30, 110], warning: [40, 100] } },
      { name: 'SpO₂', value: 75, unit: '%', icon: <Atom size={24} />, color: 'var(--chart-4)', threshold: { critical: [0, 90], warning: [90, 95] } },
      { name: 'Blood Pressure', value: '145/100', unit: 'mmHg', icon: <Droplet size={24} />, color: 'var(--chart-2)', threshold: { critical: [0, 140], warning: [120, 139] } },
    ],
  },
  {
    id: 8,
    ...
    vitalCards: [
      { name: 'Heart Rate', value: 95, unit: 'bpm', icon: <Heart size={24} />, color: 'var(--primary)', threshold: { critical: [30, 110], warning: [40, 100] } },
      { name: 'SpO₂', value: 92, unit: '%', icon: <Atom size={24} />, color: 'var(--chart-4)', threshold: { critical: [0, 90], warning: [90, 95] } },
      { name: 'Blood Pressure', value: '160/100', unit: 'mmHg', icon: <Droplet size={24} />, color: 'var(--chart-2)', threshold: { critical: [0, 140], warning: [120, 139] } },
    ],
  },
  {
    id: 9,
    ...
    vitalCards: [
      { name: 'Heart Rate', value: 60, unit: 'bpm', icon: <Heart size={24} />, color: 'var(--primary)', threshold: { critical: [30, 110], warning: [40, 100] } },
      { name: 'SpO₂', value: 97, unit: '%', icon: <Atom size={24} />, color: 'var(--chart-4)', threshold: { critical: [0, 90], warning: [90, 95] } },
      { name: 'Blood Pressure', value: '90/50', unit: 'mmHg', icon: <Droplet size={24} />, color: 'var(--chart-2)', threshold: { critical: [0, 140], warning: [120, 139] } },
    ],
  },
  {
    id: 10,
    ...
    vitalCards: [
      { name: 'Heart Rate', value: 45, unit: 'bpm', icon: <Heart size={24} />, color: 'var(--primary)', threshold: { critical: [30, 110], warning: [40, 100] } },
      { name: 'SpO₂', value: 90, unit: '%', icon: <Atom size={24} />, color: 'var(--chart-4)', threshold: { critical: [0, 90], warning: [90, 95] } },
      { name: 'Blood Pressure', value: '90/60', unit: 'mmHg', icon: <Droplet size={24} />, color: 'var(--chart-2)', threshold: { critical: [0, 140], warning: [120, 139] } },
    ],
  },
];
